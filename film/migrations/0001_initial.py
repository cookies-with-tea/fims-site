    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('covet_mini', models.ImageField(blank=True, help_text='Маленький постер фильма, который можно указать в лентепользователя или в категории - "ТОП - 10"(рекомендуемый размерзагрузки- 259x29)', null=True, upload_to='photo/cover_mini/%Y/%m/%d', verbose_name='Миниатюрная обложка фильма')),
                ...
                ('composer', models.ManyToManyField(blank=True, related_name='composer', to='film.people', verbose_name='Композитор фильма')),
                ('director', models.ManyToManyField(blank=True, related_name='director', to='film.people', verbose_name='Режисер фильма')),
                ('genre', models.ManyToManyField(blank=True, to='film.genre', verbose_name='Жанры фильма')),
                ('mounting', models.ManyToManyField(blank=True, related_name='mounting', to='film.people', verbose_name='Монтажер фильма')),
                ('operator', models.ManyToManyField(blank=True, related_name='operator', to='film.people', verbose_name='Оператор фильма')),
                ('producer', models.ManyToManyField(blank=True, related_name='producer', to='film.people', verbose_name='Продюсер фильма')),
